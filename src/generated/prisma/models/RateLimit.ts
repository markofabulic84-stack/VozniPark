...
export type RateLimitWhereInput = {
  ...
  kljuc?: Prisma.StringFilter<"RateLimit"> | string
...
export type RateLimitScalarWhereWithAggregatesInput = {
  ...
  kljuc?: Prisma.StringWithAggregatesFilter<"RateLimit"> | string
...
export type RateLimitUpdateInput = {
  kljuc?: Prisma.StringFieldUpdateOperationsInput | string
...
export type RateLimitOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"kljuc" | "count" | "resetAt", ExtArgs["result"]["rateLimit"]>
...
export interface RateLimitDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `kljuc`
   * const rateLimitWithKljucOnly = await prisma.rateLimit.findMany({ select: { kljuc: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many RateLimits and only return the `kljuc`
   * const rateLimitWithKljucOnly = await prisma.rateLimit.createManyAndReturn({
   *   select: { kljuc: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more RateLimits and only return the `kljuc`
   * const rateLimitWithKljucOnly = await prisma.rateLimit.updateManyAndReturn({
   *   select: { kljuc: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface RateLimitFieldRefs {
  readonly kljuc: Prisma.FieldRef<"RateLimit", 'String'>
